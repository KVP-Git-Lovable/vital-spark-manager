/**
 * Mirror of src/lib/prescriptionText.ts - the app and the edge functions do
 * not share a module path (same arrangement as src/lib/hsn.ts and
 * sf-import-clinical/hsnForRate.ts). Keep the two in step: the document and
 * the screen must list a visit's medicines identically.
 */
